...
class ServiceTests(unittest.TestCase):
	...
	def _testDivideWithValues(instance, mockValue, divideArg, expected):
		Service.bad_random = MagicMock(mockValue)
		assert instance.divide(divideArg) == expected
		Service.bad_random.assert_called_once()
		
	def test_divide(self):
		self._testDivideWithValues(self.instance, 1, 5, 0.2)
		self._testDivideWithValues(self.instance, 1, 0, float("inf"))
		self._testDivideWithValues(self.instance, 0, 5, 0)
		self._testDivideWithValues(self.instance, 5, 5, 1)
		self._testDivideWithValues(self.instance, -3, 5, -0.6)
		self._testDivideWithValues(self.instance, -2, -4, 0.5)
		self._testDivideWithValues(self.instance, 20000, -10000, -2)
